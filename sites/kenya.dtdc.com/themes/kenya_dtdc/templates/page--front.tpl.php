...
<div class="dd-home">
	<header>
<!-- 	<script id="Cookiebot" src="https://consent.cookiebot.com/uc.js" data-cbid="74e69fb6-498f-44f0-8044-c86295676462" type="text/javascript" data-blockingmode="auto"></script> -->
	...
	<div class="container-fluid padd_zero">
		<?php if (!empty($page['header'])): ?>
				...
				<?php endif; ?>
                   ...
                   <?php
                    $block = module_invoke('kenya_tracking', 'block_view', 'kenya_tracking_block');
                    print render($block);
                   ?>
							   </div>
								 <div class="clear"></div>
