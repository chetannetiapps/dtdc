 ...
 */
 ...
 drupal_add_css(drupal_get_path('theme', 'srilanka_dtdc') . '/css/style_map.css');
 drupal_add_js(drupal_get_path('theme', 'srilanka_dtdc') . '/js/jquery.min.js');
 drupal_add_js(drupal_get_path('theme', 'srilanka_dtdc') . '/js/connect.js');
?>
...
<li class="isrl"><a href="https://dtdc.co.il/"><span>&nbsp;</span>Israel</a></li>
              ...
              <a class="logo" href="/" title="Home"><img src="<?php print $logo; ?>" alt="Home" class="img-responsive pull-right" /></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <p class="dt-margin network_para" style="font-family:'gotham-light';font-size: 14px;text-align: center;">The biggest strength of Global Parcel Delivery is its unique network & partner-based business model. Our organisation has one of the fastest-growing franchisee business networks across the globe. We have developed the largest chain of express courier services in India and have replicated the same model in various geographies. Today, Global Parcel Delivery has business network in over 230 countries worldwide.</p>
    </div><!-- container close -->
    <?php include 'map.inc'; ?>
    <div class="clear"></div>
