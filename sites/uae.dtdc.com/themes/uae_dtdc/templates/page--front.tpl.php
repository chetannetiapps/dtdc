 ...
 */
 ...
 drupal_add_js(drupal_get_path('theme', 'uae_dtdc') . '/js/formValidation.min.js');
  drupal_add_js(drupal_get_path('theme', 'uae_dtdc') . '/js/bootstrapv.min.js');
  drupal_add_js(drupal_get_path('theme', 'uae_dtdc') . '/js/jquery.validate.js');
?>
...
// newly commented	print render($page['popup']); 
   // old comment $block = module_invoke('block', 'block_view', '16');
  // old comment print render($block['content']);
...
<div class="dd-home">
	<div class="container-fluid padd_zero">
       ...
       <div class="track1">
		  ...
		  <?php $block = module_invoke('uae_tracking', 'block_view', 'uae_tracking_block');
			print render($block); ?>
      </div>
      <div class="track2">
