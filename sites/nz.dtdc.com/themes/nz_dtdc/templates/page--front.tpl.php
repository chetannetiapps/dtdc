		...
		<?php if (!empty($page['header'])): ?>
				...
				<?php endif; ?>
						 <div class="dt-home-search">
							 <!-- <div class="dt-ebook"><a href="#">E-BOOKING</a></div> -->
							 <div class="dt-track-ship">TRACK YOUR SHIPMENT</div>
							 <div class="clear"></div>
							 <div class="track-form-wrap1">
								 <div class='form-inline'>
                   <?php
                    $block = module_invoke('nz_tracking', 'block_view', 'nz_tracking_block');
                    print render($block);
                   ?>
							</div>
								 <div class="clear"></div>
...
<div class="container-fluid services_block">
	<div class="row">
		 <div class="container">
		 	 <?php  $block = module_invoke('views', 'block_view', 'product_service_home-block');
