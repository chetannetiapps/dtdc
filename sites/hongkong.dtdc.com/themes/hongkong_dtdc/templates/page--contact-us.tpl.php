...
<li class="isrl"><a href="https://dtdc.co.il/"><span>&nbsp;</span><?php print t("Israel");?></a></li>
    ...
    <!-- Header block -->
     <?php global $base_url; ?>
  <div class="container-fluid dt-reachus text-center"> <img src="<?php print $base_url."/sites/china.dtdc.com/themes/china_dtdc/images/locater.png"?>" class="img-responsive dt-locater">
