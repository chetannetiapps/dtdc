  ...
  <div class="container">
    <div class="row">
      <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#opportunities" aria-controls="home" role="tab" data-toggle="tab"><?php print t("Opportunities"); ?></a></li>
        <li role="presentation"><a href="#workculture" aria-controls="profile" role="tab" data-toggle="tab"><?php print t("Work Culture"); ?></a></li>
      </ul>
