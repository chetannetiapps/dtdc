...
<div style="display: none;">
	<div id="popup-message">
		<iframe width="100%" height="380px" src="/en/vef/load/e1747c34b607ebeead9267093e12ea21" frameborder="0" allowfullscreen=""></iframe>
	</div>
</div>
<!----------------------------------------Header block-------------------------------------------------------------->
<div class="dd-home">
...
<li class="isrl"><a href="https://dtdc.co.il/"><span>&nbsp;</span><?php print t("Israel");?></a></li>
              ...
              if($lang_name =="zh-hans"){ $lang_name="cmn";} ?>
 				 <a class="logo" href='<?php print "/$lang_name";?>' title="Home"><img src="<?php print $base_url."/sites/usa.dtdc.com/themes/usa_dtdc/images/dtdc_logo.png"; ?>" alt="Home" class="img-responsive pull-right" /></a>
 			 </div>
 		 </div>
 	 </div>
  </div>
	...
	<div class="container">
		<div class="row">
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#product_e-commerce" aria-controls="home" role="tab" data-toggle="tab"><?php print t("E-Commerce"); ?></a></li>
				<li role="presentation"><a href="#product_international" aria-controls="profile" role="tab" data-toggle="tab"><?php print t("International"); ?></a></li>
				<li role="presentation"><a href="#product_domestic" aria-controls="messages" role="tab" data-toggle="tab"><?php print t("Domestic"); ?></a></li>
				<li role="presentation"><a href="#product_e-fulfilment" aria-controls="settings" role="tab" data-toggle="tab"><?php print t("E-Fulfilment"); ?></a></li>
			</ul>
