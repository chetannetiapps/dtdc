 ...
 */
 ...
 drupal_add_css(drupal_get_path('theme', 'hongkong_dtdc') . '/css/style_map.css');
 drupal_add_js(drupal_get_path('theme', 'hongkong_dtdc') . '/js/jquery.min.js');
 drupal_add_js(drupal_get_path('theme', 'hongkong_dtdc') . '/js/connect.js');
?>
    <!----------------------------------------Header block-------------------------------------------------------------->
    <div class="dd-home">
    	<header>
...
<li class="isrl"><a href="https://dtdc.co.il/"><span>&nbsp;</span><?php print t("Israel");?></a></li>
    ...
    <div class="container">
      ...
      <?php print t('The biggest strength of DTDC is its unique network & partner-based business model.
    ...
    <div class="footer-addr">
      <p><b><?php print t("DTDC Headquarter:"); ?></b> <br><?php print t("DTDC House No.3, Victoria Road, Bangalore 560047, Karnataka <br>Tel: 080-25365032, 25365039"); ?></p>
    </div>
