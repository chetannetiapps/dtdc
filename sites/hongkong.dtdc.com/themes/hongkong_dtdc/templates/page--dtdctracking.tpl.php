...
<div class="panel panel-default" id="panel1">
  ...
  foreach ($trackRecords as $trackRecord) {
    if(isset($trackRecord['tracking-no'])) {
      echo '<iframe  class="iframe-class" src="http://dtdc.com/tracking/tracking_results_api.asp?strCnno='.$trackRecord['tracking-no'].'&Ttype=awb_no" height="1225"  id="dom-tracking"></iframe>';
    }
    else {
    ?>
