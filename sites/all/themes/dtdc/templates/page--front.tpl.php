...
drupal_add_js(drupal_get_path('theme', 'dtdc') . '/js/jquery.colorbox.js');
...
<script type="text/javascript">
 ...
 <!-- Enable this to show popup on front page -->
<!--- Start custom popup -->
 <div style="display: none;">
	<div id="popup-message">
		<?php
			// echo "<a href="."www.google.com".">Click Here</a>";
			print render($page['home_page_popup']); //this is for the static banner just need to place "popups" block in this region. 
			echo views_embed_view('pop_up_slider', 'block'); //slider banner images
   ?>
	</div>
</div> 
	...
	<div style='display:none'>
	 <div id="inline_content222">
		<div class="track-form-wrap1">
			 <div class="form-inline">
				 <?php
				// print $messages;
				  print render($page['tracking_block']);
				 ?>
			 </div>
			 <div class="clear"></div>
		 </div>
	 ...
	 <div id="requestdemo">
		<div class="request-form">
			 <div class="form-inline">
				 <?php
				$block = module_invoke('ebooking', 'block_view', 'request_form_block');
				print render($block);
				?>
			 </div>
			 <div class="clear"></div>
  ...
  <div class="row">
    <div class="container">
      ...
      <div class="service_list row">
        <?php
             $block = module_invoke("views","block_view","product_services-block_1");
               print render($block['content']);
          ?>
      </div>
    </div>
...
<div class="clear"></div>
<div class="video">
  <?php print render($page['video_block']);?>
</div>
...
<div class="container-fluid">
  <div class="row">
    <div class="container">
      <?php
          // $block = module_invoke('block','block_view','51');
          // print render($block['content']);
       ?>
      </div>
    </div>
	...
	<div class="container-fluid dt-footer">
	  ...
	  <div class="container">
	    <div class="block-wrap">
           ...
           */ ?>
	        <div class="carousel-inner" role="listbox">
	         <div class="item active">
	            <div class="caption">
	              <div class="mystring hide">I want to compliment to your excellent service as your entire team always went to great
	                lengths to help me to enhance my business. I have always received quality service at your FC. Team knows just what
	                to do to solve my issues quickly and always come with solution-oriented approach. Such service builds great working
	                relationships.
	              </div>
	              <div class="demo-txt"></div>
	            </div>
	            <h5 class="test_name">
	          ...
	          <div class="item">
	            <div class="caption">
	              <div class="mystring hide">DTDC Fulfilment Service for sellers has given me the edge to upgrade my business. I can now work on my core competency which is to source goods.
	              The FC has world class facilities and products go through a series of Quality check. They nicely pack my items and have a very short processing time, which is delighting my customers.
	              Thanks.
	              </div>
	              <div class="demo-txt"></div>
	            </div>
	         ...
	         <div class="item">
	            <div class="caption">
	              <div class="mystring hide">Thank you very much for safe delivery. My daughter is very happy for the gift. Very good service.
	              </div>
	              <div class="demo-txt"></div>
	            </div>
	            <h5 class="test_name">
          ...
          */
          ?>
            <a class="left carousel-control" href="#js-carousel" role="button" data-slide="prev">
	            <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
	            <span class="sr-only">Previous</span>
	          </a>
	          <a class="right carousel-control" href="#js-carousel" role="button" data-slide="next">
...
<script>
  jQuery(document).ready(function(){
    jQuery(".inline").colorbox({inline:true, width:"35%", Position:false, className: 'my-class',  fixed: true});
  });
</script>

<!-- js for sliders starts -->
