 ...
 * @ingroup themeable
 */
 //drupal_add_css(drupal_get_path('theme', 'dtdc') . '/css/style_map.css');
 //drupal_add_js(drupal_get_path('theme', 'dtdc') . '/js/jquery.min.js');
 drupal_add_js(drupal_get_path('theme', 'dtdc') . '/js/connect.js');
...
?>
    		...
    		<div class="container-fluid nav_fixed">
    			<div class="row ">
                  ...
                  <?php /* Brand and toggle get grouped for better mobile display */ ?>
    			        ...
    			        <?php /* Collection of nav links, forms, and other content for toggling */ ?>
    ...
    <div class="main-container">
      ...
      <h1>worldwide network</h1>
          <p>Extending the Horizon<br/><br/></p>
      <div class="clear"></div>
      </div>

    <div class="container">
      <p class="dt-margin network_para" style="font-family:'gotham-light';font-size: 14px;text-align: center;margin: 45px 0 60px;">The biggest strength of DTDC is its unique network & partner-based business model.
