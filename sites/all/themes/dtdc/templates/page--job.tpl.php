...
<script type="text/javascript">
	jQuery(document).ready(function($){
		...
		$(".view-display-id-attachment_1").hide();
		$(".switch-map-view").click(function(){
		  $(".view-display-id-attachment_1").hide();
		  $(".switch-list-view").show();
		  $(".ip-geoloc-map").show();
		 });
		$(".switch-list-view").click(function(){
		  $(".view-display-id-attachment_1").show();
		 $(".switch-list-view").hide();
		  $(".ip-geoloc-map").hide();
		 });
    ...
    <div class="main-container">
      ...
      <!-- .btn-navbar is used as the toggle for collapsed navbar content -->
       ...
       <!--<div class="banner-img-wrapper"><img src="../../sites/all/themes/dtdc/images/b10.png"></div>-->
<div class="contact-us-wrapper container">
    ...
    <section<?php print $content_column_class; ?>>
      ...
      <div class="job-desc-right">
      <?php
        /* Print webform block content */
