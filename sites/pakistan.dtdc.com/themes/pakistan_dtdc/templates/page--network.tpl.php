 ...
 */
 ...
 drupal_add_css(drupal_get_path('theme', 'pakistan_dtdc') . '/css/style_map.css');
 drupal_add_js(drupal_get_path('theme', 'pakistan_dtdc') . '/js/jquery.min.js');
 drupal_add_js(drupal_get_path('theme', 'pakistan_dtdc') . '/js/connect.js');
?>
    ...
    <div class="container">
      ...
      <img class="bg" src="sites/canada.dtdc.com/themes/ca_dtdc/images/DTDC-banner.png" class="img-responsive"/>
      <img class="map" src="sites/canada.dtdc.com/themes/ca_dtdc/images/map.png" class="img-responsive"/>
