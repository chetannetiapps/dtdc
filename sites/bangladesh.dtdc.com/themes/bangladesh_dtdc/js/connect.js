...
$("#Layer_1 g circle").hover(function (e) {
    $(this).css({'padding':50});
    var idvar = $(this).parent().attr('id').split('-')[1];
        var address = locdata.locations[idvar].address;
        var offset = $(this).position();
        var dis = $('.svg-wrapper').offset().top;
        if(address == "" || address == "null"){
            ...
            $("div.popup").css({"left": e.pageX-130-90, "top": e.pageY-dis-130});
