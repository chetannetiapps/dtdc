...
?>
 ...
 jQuery(document).ready(function() {
  ...
  jQuery.colorbox({ href: '#popup-message', width:"750", inline: true, scrolling: false, opacity:.8 });
  }
 });
</script>
<div class="dd-home">
...
<div class="container-fluid">
  ...
  <?php
  $block = module_invoke('bangladesh_tracking', 'block_view', 'bangladesh_tracking_block');
  print render($block);
  ?>
  </div>
  <div class="clear"></div>
    ...
    <div class="container">
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        <div class="dt-foot-social">
          <a href="https://www.facebook.com/DTDC.Official/" target="_blank"><img src="/sites/bangladesh.dtdc.com/themes/bangladesh_dtdc/images/facebook.png" alt="" title=""/></a>
          ...
          <a href="https://twitter.com/search?q=DTDC%20India&src=typd" target="_blank"><img src="/sites/bangladesh.dtdc.com/themes/bangladesh_dtdc/images/twitter.png" alt="" title=""/> </a>
