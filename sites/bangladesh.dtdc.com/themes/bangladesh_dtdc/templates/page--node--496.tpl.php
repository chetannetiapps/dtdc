 ...
 */
 ...
 drupal_add_css(drupal_get_path('theme', 'bangladesh_dtdc') . '/css/style_map.css');
 drupal_add_js(drupal_get_path('theme', 'bangladesh_dtdc') . '/js/jquery.min.js');
 //drupal_add_js(drupal_get_path('theme', 'bangladesh_dtdc') . '/js/bootstrap.min.js');
 drupal_add_js(drupal_get_path('theme', 'bangladesh_dtdc') . '/js/connect.js');
?>
...
<!-- <li class="de"><a href="http://de.dtdc.com/"><span>&nbsp;</span>Germany</a></li> -->
 ...
 <li class="isrl"><a href="https://dtdc.co.il/"><span>&nbsp;</span>Israel</a></li>
                    ...
                    <!-- <li class="oman"><a href="http://oman.dtdc.com/"><span>&nbsp;</span>Oman</a></li> -->
					 <!--  <li class="nz"><a href="http://nz.dtdc.com/"><span>&nbsp;</span>Nepal</a></li> -->
