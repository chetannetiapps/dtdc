 ...
 */
 ...
 drupal_add_js(drupal_get_path('theme', 'nepal_dtdc') . '/css/style_map.css');
  drupal_add_js(drupal_get_path('theme', 'nepal_dtdc') . '/js/jquery.min.js');
 drupal_add_js(drupal_get_path('theme', 'nepal_dtdc') . '/js/connect.js');
?>
