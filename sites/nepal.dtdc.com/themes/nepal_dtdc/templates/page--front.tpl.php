		...
		<?php if (!empty($page['header'])): ?>
				...
				<?php endif; ?>
						 <div class="dt-home-search">
							 <!-- <div class="dt-ebook"><a href="http://ws01.ffdx.net/customer_v2/index.aspx?token=68-0A-A0-62-5A-38-17-75-20-6A-9D-59-F2-C5-F1-B4" target="_blank">E-BOOKING</a></div> -->
							 <div class="dt-track-ship">TRACK YOUR SHIPMENT</div>
							 <div class="clear"></div>
							 <div class="track-form-wrap1">
								 <div class='form-inline'>
								 <?php
									$block = module_invoke('nepal_tracking', 'block_view', 'nepal_tracking_block');
									print render($block);
								?>
							</div>
								 <div class="clear"></div>
