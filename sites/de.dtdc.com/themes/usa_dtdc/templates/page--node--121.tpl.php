...
<div style="display: none;">
	<div id="popup-message">
   <iframe id="val_frame" class="videosrc" src="/sites/default/files/videoplayback.mp4" allowfullscreen="" width="100%" height="360" frameborder="0"></iframe>
	</div>
</div>
<!----------------------------------------Header block-------------------------------------------------------------->
<div class="dd-home">
	...
	<div class="container">
		<div class="row">
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#product_e-commerce" aria-controls="home" role="tab" data-toggle="tab">E-Commerce</a></li>
				<li role="presentation"><a href="#product_international" aria-controls="profile" role="tab" data-toggle="tab">International</a></li>
				<li role="presentation"><a href="#product_domestic" aria-controls="messages" role="tab" data-toggle="tab">Domestic</a></li>
				<li role="presentation"><a href="#product_e-fulfilment" aria-controls="settings" role="tab" data-toggle="tab">E-Fulfilment</a></li>
			</ul>
