 ...
 */
 ...
 drupal_add_css(drupal_get_path('theme', 'china_dtdc') . '/css/style_map.css');
 drupal_add_js(drupal_get_path('theme', 'china_dtdc') . '/js/jquery.min.js');
 drupal_add_js(drupal_get_path('theme', 'china_dtdc') . '/js/connect.js');
?>
    <!----------------------------------------Header block-------------------------------------------------------------->
    <div class="dd-home">
    	<header>
