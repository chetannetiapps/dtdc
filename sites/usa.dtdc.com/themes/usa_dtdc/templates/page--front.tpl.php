 ...
 */
 render($page['content']['metatags']);
  drupal_add_js(drupal_get_path('theme', 'usa_dtdc') . '/js/formValidation.min.js');
  drupal_add_js(drupal_get_path('theme', 'usa_dtdc') . '/js/bootstrapv.min.js');
  drupal_add_js(drupal_get_path('theme', 'usa_dtdc') . '/js/jquery.validate.js');
?>
<style type="text/css">
...
<li class="isrl"><a href="https://dtdc.co.il/"><span>&nbsp;</span>Israel</a></li>
					...
					<a class="logo" href="/" title="Home"><img src="sites/usa.dtdc.com/themes/usa_dtdc/images/dtdc_logo.png" alt="International Shipping - DTDC"  class="img-responsive pull-right" /></a>
				</div>
			</div>
		</div>
	</div>
...
<div class="dd-home">
	<div class="container-fluid padd_zero">
       ...
       <div class="track1">
		  ...
		  <?php $block = module_invoke('usa_tracking', 'block_view', 'usa_tracking_block');
			print render($block); ?>
      </div>
      <div class="track2">
