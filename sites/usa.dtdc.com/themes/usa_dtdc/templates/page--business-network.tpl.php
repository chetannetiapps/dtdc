    ...
    <div class="main-container">
      ...
      <div class="container">
        <p class="dt-margin network_para" style="font-family:'gotham-light';font-size: 14px;text-align: center;">The biggest strength of DTDC is its unique network & partner-based business model.
          ...
          the largest chain of <a href="http://uk.dtdc.com/product-services#product_domestic">express courier services</a> in India and have replicated the same model in various geographies.
