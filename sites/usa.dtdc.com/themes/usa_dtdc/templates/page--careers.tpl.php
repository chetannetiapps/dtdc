 ...
 */
 ...
 drupal_add_js(drupal_get_path('theme', 'usa_dtdc') . '/js/jquery.colorbox.js');
?>

 <div style="display: none;">
	<div id="popup-message">
	    <!-- <?php print render($page['current_opening']); ?> -->
  ...
  <div class="container">
    <div class="row">
      <ul class="nav nav-tabs" role="tablist">
       <li role="presentation" class="active"><a href="#currentopening" aria-controls="home" role="tab" data-toggle="tab">Current Opening</a></li>
        <li role="presentation"><a href="#opportunities" aria-controls="home" role="tab" data-toggle="tab">Opportunities</a></li>
        <li role="presentation"><a href="#workculture" aria-controls="profile" role="tab" data-toggle="tab">Work Culture</a></li>
      </ul>
      <div class="tab-content">
		<?php $block = module_invoke('custom_tabs_block', 'block_view', 'custom_careers_tabs_block');
...
jQuery(document).ready(function() {
  //  jQuery("#colorbox").addClass("career-popup");
  // if (jQuery('#popup-message').length > 0) {
  //   jQuery.colorbox({ href: '#popup-message', width:"75%", top:"47px",  inline: true, scrolling: false, opacity:.8 });
  // }
   // jQuery(".inline").colorbox({inline:true, width:"75%", Position:false, className: 'my-class',  fixed: true});
});
// function printpopupDiv() 
// {
// var divToPrint=document.getElementById('colorbox');
// var header = document.getElementsByClassName('dd-home');
// var title = document.getElementsByClassName('dt-bg7');
// var footer = document.getElementsByClassName('region-footer');
// var newWin=window.open('','Print-Window');
// newWin.document.open();
// newWin.document.write('<html><body onload="window.print()"><div class="container-fluid dt-inner-banner dt-bg7">'+'<h1>Careers</h1><p>Explore the Success<br><div class="clear"></div></div>'+divToPrint.innerHTML+'</body></html>');
