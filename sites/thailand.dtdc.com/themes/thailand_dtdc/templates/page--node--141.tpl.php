...
<div style="display: none;">
	<div id="popup-message">
		<iframe width="100%" height="380px" src="https://www.youtube.com/embed/c8TTAgdOC50?&amp;rel=0&amp;autohide=1" frameborder="0" allowfullscreen=""></iframe>
	</div>
</div>
<!--Header block-->
<div class="dd-home">
	...
	<div class="container">
		<div class="row">
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#ecommerce" aria-controls="home" role="tab" data-toggle="tab">การพาณิชย์อิเล็กทรอนิกส์</a></li>
				<li role="presentation"><a href="#international" aria-controls="profile" role="tab" data-toggle="tab">ระหว่างประเทศ</a></li>
				<li role="presentation"><a href="#domestic" aria-controls="messages" role="tab" data-toggle="tab">ภายในประเทศ</a></li>
				<li role="presentation"><a href="#efulfilment" aria-controls="settings" role="tab" data-toggle="tab">ความสำเร็จทางอิเล็กทรอนิกส์</a></li>
			</ul>
		  <div class="tab-content dt-service-tab">
		     <?php $block = module_invoke('custom_tabs_block', 'block_view', 'custom_service_th_tabs_block');
