...
<?php echo $node->body['und'][0]['summary']; ?><br/>
<div class="clear"></div>
</div>
<div class="container-fluid dt-tab career">
<div class="container">
	<div class="row">
	  <ul class="nav nav-tabs" role="tablist">
	    <li role="presentation" class="active"><a href="#opportunities" aria-controls="home" role="tab" data-toggle="tab">โอกาส</a></li>
	    <li role="presentation"><a href="#workculture" aria-controls="profile" role="tab" data-toggle="tab">วฒนธรรมในการทงาน</a></li>
	  </ul>
	<div class="tab-content dt-service-tab">
	<?php
	$block = module_invoke("custom_tabs_block","block_view","custom_careers_th_tabs_block");
