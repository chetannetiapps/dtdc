...
<?php $nid = arg(1);
 if($nid == '181' || $nid == "186") { ?>
 <div class="container-fluid dt-inner-banner dt-bg4">
      <h1><?php //echo $node->title; ?></h1>
      <?php echo $node->body['und'][0]['summary']; ?>
      <div class="clear"></div>
    </div>
    <div class="container-fluid dt-track">
      <div class="container">
        <div class="row">
          <div class="track-form-wrap">
            <div class='form-inline'>
              <?php
               $block = module_invoke('thailand_tracking', 'block_view', 'thailand_tracking_block');
               print render($block);
             ?>
             </div>
             <div class="clear"></div>
...
<div class="container-fluid">
 ...
 <?php }
 elseif($nid == '216' || $nid == '221') { ?>
 <div class="container-fluid dt-reachus text-center"> <img src="/sites/china.dtdc.com/themes/china_dtdc/images/locater.png" class="img-responsive dt-locater">
    <p><?php echo $node->body['und'][0]['summary']; ?></p>
     <div class="clearfix"></div>
  </div>
  <div class="container">
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 marg_auto dt-office">
...
<div class="clearfix"></div>
 ...
 <div class="container-fluid">
    <div class="dt-network-wrap">
      <div class="container">
        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 dt-terms">
          <?php print render($page['content']); ?>
        </div>
      </div>
    </div>
