    ...
    attach: function (context, settings) {
      ...
      $("#edit-choose-country").change(function(){
            ...
            window.open('http://ws01.ffdx.net/customer_v2/index.aspx?token=1E-02-52-CB-98-AB-84-20-F7-19-F2-F1-C8-5B-DD-94', '_blank');
        		...
        		window.open('http://dtdc.in/Pickup_request.asp', '_blank');
            }if(type==3){
      ...
      $("#edit-locate-us-country").change(function(){
		      var type = $(this).val();
        		if(type==1){
        		window.open('http://www.dtdcaustralia.com.au/courier-contact.html', '_blank');
            }if(type==2){
            ...
            window.open('http://dtdc.in/contact_presence.asp','_blank');
            }if(type==7){
