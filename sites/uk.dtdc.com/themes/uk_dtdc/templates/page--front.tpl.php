 ...
 */
 ...
 drupal_add_js(drupal_get_path('theme', 'uk_dtdc') . '/js/formValidation.min.js');
  drupal_add_js(drupal_get_path('theme', 'uk_dtdc') . '/js/bootstrapv.min.js');
  drupal_add_js(drupal_get_path('theme', 'uk_dtdc') . '/js/jquery.validate.js');
?>
<!----------------------------------------Header block-------------------------------------------------------------->
<div class="dd-home">
	<header>
...
<div class="dd-home">
	<div class="container-fluid padd_zero">
       ...
       <div class="track1">
		  ...
		  <?php $block = module_invoke('uk_tracking', 'block_view', 'uk_tracking_block');
			print render($block); ?>
      </div>
      <div class="track2">
...
<!--- Start custom popup -->
 <div style="display: none;">
    ...
    <?php
        ...
        // print render($page['popup']); //this is for the static banner
   ?>
	</div>
</div>
