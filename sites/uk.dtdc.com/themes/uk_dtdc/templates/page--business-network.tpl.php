 ...
 * @ingroup themeable
 */
 drupal_add_css(drupal_get_path('theme', 'uk_dtdc') . '/css/style_map.css');
 drupal_add_js(drupal_get_path('theme', 'uk_dtdc') . '/js/jquery.min.js');
 drupal_add_js(drupal_get_path('theme', 'uk_dtdc') . '/js/connect.js');
...
<li class="isrl"><a href="https://dtdc.co.il/"><span>&nbsp;</span>Israel</a></li>
    ...
    <div class="container">
      <div class="row dt-terms dt-cookie">
        <div class="dt-margin network_para">
