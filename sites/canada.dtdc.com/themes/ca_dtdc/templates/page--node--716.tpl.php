 ...
 * @ingroup themeable
 */
drupal_add_css(drupal_get_path('theme', 'ca_dtdc') . '/css/style_map.css');
drupal_add_js(drupal_get_path('theme', 'ca_dtdc') . '/js/jquery.min.js');
 // drupal_add_js(drupal_get_path('theme', 'ca_dtdc') . '/js/bootstrap.min.js');
drupal_add_js(drupal_get_path('theme', 'ca_dtdc') . '/js/connect.js');
