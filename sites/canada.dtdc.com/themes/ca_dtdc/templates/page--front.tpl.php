...
drupal_add_css(drupal_get_path('theme', 'ca_dtdc') . '/css/colorbox.css');
render($page['content']['metatags']);
 drupal_add_js(drupal_get_path('theme', 'ca_dtdc') . '/js/formValidation.min.js');
  drupal_add_js(drupal_get_path('theme', 'ca_dtdc') . '/js/bootstrapv.min.js');
  drupal_add_js(drupal_get_path('theme', 'ca_dtdc') . '/js/jquery.validate.js');
?>
...
<li class="isrl"><a href="https://dtdc.co.il/"><span>&nbsp;</span>Israel</a></li>
					...
					<a class="logo" href="/" title="Home"><img src="sites/canada.dtdc.com/themes/ca_dtdc/images/dtdc_logo.png" alt="Home" class="img-responsive pull-right" /></a>
				</div>
			</div>
		</div>
	</div>
...
<div class="dd-home">
       ...
       <div class="track1">
		  ...
		  <?php $block = module_invoke('canada_tracking', 'block_view', 'canada_tracking_block');
			print render($block); ?>
      </div>
      <div class="track2">
...
<div class="container-fluid">
	<div class="row">
		 <div class="container">
		 		     <?php  $block = module_invoke('views', 'block_view', 'product_services-block');
		 				        print render($block['content']); ?>
		</div>
	</div>
</div>
  ...
  <div class="views-row views-row-1 views-row-odd views-row-first views-row-last">
          ...
          <div class="views-field views-field-field-delivery-image">
            <div class="field-content"> 
                ...
                <img typeof="foaf:Image" src="/sites/canada.dtdc.com/themes/ca_dtdc/images/logo_IATA.png" height="55" alt="">
...
<!--- Start custom popup -->
 <div style="display: none;">
    ...
    <?php
      ...
      echo views_embed_view('popup_slider', 'block');
