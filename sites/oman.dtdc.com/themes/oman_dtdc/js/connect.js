jQuery(document).ready(function() {
    ...
    var locdata = {
        "locations": [{
            ...
            "cx": 135,
            "cy": 40,
           "address":'Unit C, ISIS House,;5-6, Horton Road, Colnbrook;Slough,SL3 0DF',
            ...
            "cx": 173,
            "cy": 100,
            "address" : 'G-20, Lunga Lunga Square,;Lunga Lunga Road, Industrial Area,;Nairobi, oman',
            ...
            "cx": 219,
            "cy": 82,
            "address" : '47, Skelton Garden,;Colombo - 05,;Sri Lanka',
    ...
    for (i = 0; i < locdata.locations.length; i++) {
        ...
        //     || (backClass == 'backMalaysia')|| (backClass == 'backoman') || (backClass == 'backHongKong')
...
jQuery("#Layer_1 g circle").hover(function (e) {
    ...
    var idvar = jQuery(this).parent().attr('id').split('-')[1];
        ...
        if(address == "" || address == "null"){
            ...
            jQuery("div.popup").css({"left": e.pageX-90, "top": e.pageY-dis-130});
